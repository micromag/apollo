<template>
    ...
    <div class="flex-1 h-screen overflow-auto relative" style="padding: env(safe-area-inset-right) env(safe-area-inset-left);" :class="[isMobile ? 'mb-6' : '']">
      <div class="border-b fixed top-0 left-0 right-0 safeMobile shadow-md dark:border-gray-800 z-10" :class="[isMobile ? 'bg-blue-bar dark:bg-gray-900' : 'bg-white ml-64 dark:bg-gray-900']" style="padding: env(safe-area-inset-top) env(safe-area-inset-right) env(safe-area-inset-bottom) env(safe-area-inset-left);">
